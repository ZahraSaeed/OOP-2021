...
public class Accounts implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        Accounts[] accounts = new Accounts[]
                {
                        new Accounts("1","Nimra","26000"),
                        new Accounts("2","Zahra","54500"),
                        new Accounts("3","Bisma","72300"),
                        new Accounts("4","Noor","40000"),
                        new Accounts("5","Hiba","97400"),
                        new Accounts("6","Tooba","89050"),
                        new Accounts("7","Bakhtawar","63000"),
                        new Accounts("8","Sanabil","39000"),
                        new Accounts("9","Samra","46500"),
                        new Accounts("10","Ayesha","90000"), };
    ...
    public static ArrayList<Accounts> readObjectFromFile() {
        ...
        try {
            FileInputStream fileInputStream= new FileInputStream("C:\\Users\\Zahra\\IdeaProjects\\Lab 14\\Account.txt");
